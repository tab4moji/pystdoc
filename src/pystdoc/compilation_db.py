"""Compilation database (compile_commands.json) parser and flags resolver."""
...
class CompilationDatabase:
    ...
    def __init__(
        self, db_path: Optional[Path] = None, target_dir: Optional[Path] = None
    ):
    ...
    def _load_db(self, db_file: Path) -> None:
        """Parse compile_commands.json and extract flags for source files."""
    ...
    def get_flags_for_file(self, file_path: Path) -> List[str]:
        """Get compilation flags for a given source file, or defaults."""
